package com.sofiqul.controller;

import com.nulabinc.zxcvbn.Strength;
import com.nulabinc.zxcvbn.Zxcvbn;
import com.sofiqul.model.User;
import com.sofiqul.service.UserService;
...
public class RegisterController {
        ...
        private static String USER_NAME = "sofiqul54.java";  // GMail user name (just the part before "@gmail.com")
        private static String PASSWORD = "Asdf@1234#"; // GMail password
        ...
        private static void sendFromGMail(String from, String pass, String[] to, String subject, String body) {
            ...
            try {
                message.setFrom(new InternetAddress("sofiqul54.java.com", "SOFIQUL Inc."));
