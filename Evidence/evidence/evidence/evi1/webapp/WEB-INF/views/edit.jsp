...
<div class="container">
  <h2>Student form</h2>
  <form:form class="form-horizontal" action="/evi1/edit/${id}" method="post" modelAttribute="student">
    <div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">          
		<form:input path="lastName" type="text" class="form-control" id="lastName" placeholder="Enter Last Name" name="lastName"/>
      </div>
    </div>
