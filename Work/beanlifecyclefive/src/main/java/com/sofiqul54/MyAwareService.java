...
public class MyAwareService implements ApplicationContextAware, ApplicationEventPublisherAware, BeanClassLoaderAware,
    ...
    public void setBeanClassLoader(ClassLoader classLoader) {
        ...
        System.out.println("setBeanClassLoader:: Class Loder Name"+ classLoader.getClass().getName());
    }
    ...
    public void setApplicationContext(ApplicationContext ctx) throws BeansException {
        ...
        System.out.println("setApplicationContext:: bean dafination  name"+ Arrays.toString(ctx.getBeanDefinitionNames()));
    }
